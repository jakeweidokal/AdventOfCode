const rawPassports = `byr:2024 iyr:2016
...
passports = rawPassports.split('\n\n');
numValidPassports = getNumValidPassports(passports);
  ...
  return passports
    ...
    .reduce((numValid, passportFields) => {
      if (passportFields.length === 8) {
        ...
        return passportFields.includes('cid') ? numValid : ++numValid;
      }
    }, 0);
}
