const rawBagRules = `shiny purple bags contain 2 pale blue bags, 1 wavy fuchsia bag, 5 pale salmon bags.
...
const bagRules = rawBagRules.split('\n');
bagRuleDict = bagRules.reduce((acc, cur) => {
	curBagContains = cur.indexOf();
	acc[cur.split(' ').slice(0,2).join('')] = 
	return { ...acc, };
}, {});
